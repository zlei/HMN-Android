 ...
 * filtering the app list by state.
...
public class GlobalAppList
{
	...
	public static void init(PackageManager packageManager, ActivityManager activityManager)
	{
	 ...
	 * 
	 * @param packageManager allows querying the phone for its app list
	 * @param activityManager aids in determining app state
	 */
	private GlobalAppList(PackageManager packageManager, ActivityManager activityManager)
	{
	...
	private void loadDisplayApps()
	{
		...
		else
		{
			switch (displayState)
			{
				case ACTIVE: displayedApps = getActive(); break;
				case RUNNING: displayedApps = getRunningApps(); break;
				case FOREGROUND: displayedApps = getForegroundApps(); break;
				case BACKGROUND: displayedApps = getBackgroundApps(); break;
				case CACHED: displayedApps = getCachedApps(); break;
				case NOTRUNNING: displayedApps = getNotRunningApps(); break;
				default: displayedApps = allApps;
			}
		}
	}
	...
	{
		return filter(AppCollector.getRunningApps(packageManager, activityManager));
	}
	...
	{
		return filter(AppCollector.getForegroundApps(packageManager, activityManager));
	}
	...
	{
		return filter(AppCollector.getBackgroundApps(packageManager, activityManager));
	}
	...
	{
		return filter(AppCollector.getCachedApps(packageManager, activityManager));
	}
	 ...
	 * 
	 * @param apps a list of applications to return
	 ...
	 * 
	 * @param uid the UID of the app to be retrieved
	...
	/**
	 * Determines the current state of the given app.
	 * This method should be used sparingly, as it is computationally expensive.
	 * 
	 ...
	 * 
	 * @param appList the list of whose stats to clear
	 */
