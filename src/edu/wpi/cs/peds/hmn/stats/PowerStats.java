...
public class PowerStats
{
	...
	/**
	 * Ensures the only way a PowerStats object can be made is through {@link #gatherPowerStats(Context) gatherPowerStats}.
	 */
	private PowerStats() 
	{
	 ...
	 * 
	 * @param context dictates where to query for this info.
	 ...
	 * 
	 * @param context used to get the PowerManager, which is queried for the
	 * screen state.
	 ...
	 * 
	 * @param batteryStatus contains extra info about the phone's power state.
	 ...
	 */
	private static PowerStats.ChargingMethod getChargingMethod(Intent batteryStatus)
	{
	...
	public String detailedInfo()
	{
		...
		powerStatsStr.append(String.format("remaining battery: %d%\n",(batteryPercentage*100)));
