...
public class AppStatCollectorBootReceiver extends BroadcastReceiver
{
	 ...
	 * This behavior is defined in the Manifest.
	 * When this function is called, it boots the AppCollectorService.
	 */
	@Override
	public void onReceive(Context context, Intent intent)
	{
		if (intent.getAction().equals(Intent.ACTION_BOOT_COMPLETED) && AppCollectorService.startOnBoot)
		{
			Intent deviceBootIntent = new Intent(context, AppCollectorService.class);
			deviceBootIntent.putExtra("edu.wpi.cs.peds.hmn.appstatviewer.action.devicebooted", true);
